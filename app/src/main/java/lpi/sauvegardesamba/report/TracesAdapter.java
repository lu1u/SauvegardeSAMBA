...
{
	int date = cursor.getInt(cursor.getColumnIndex(DatabaseHelper.COLONNE_TRACES_DATE));
	String ligne = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLONNE_TRACES_LIGNE));
	Report.NIVEAU n = Report.toNIVEAU(cursor.getInt(cursor.getColumnIndex(DatabaseHelper.COLONNE_TRACES_NIVEAU)));
